...
if not NS then
    print("|cFFFF0000[Diddy AIO Rogue]|r Core module not loaded!")
    return
end
...
local function validate_playstyle_spells(playstyle)
    ...
    print("|cFF00FF00[Diddy AIO]|r Switched to Rogue " .. playstyle .. " playstyle")
...
-- MODULE LOADED
-- ============================================================================
print("|cFF00FF00[Diddy AIO Rogue]|r Class module loaded")
