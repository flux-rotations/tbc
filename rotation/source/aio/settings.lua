...
local CLASS_TITLE_COLORS = { Druid = "ff7d0a", Hunter = "abd473" }
...
-- ============================================================================
local THEME = {
    bg          = { 0.067, 0.067, 0.078, 0.97 },   -- #111114
    bg_light    = { 0.098, 0.098, 0.118, 1 },       -- #19191e
    ...
    accent_bg   = { 0.11, 0.106, 0.189, 1 },        -- accent @ 12% over bg
...
local function create_main_frame()
    ...
    title:SetPoint("TOPLEFT", THEME.pad, -10)
...
local function create_minimap_button()
    ...
    icon:SetTexture("Interface\\Icons\\ClassIcon_" .. _G.Action.PlayerClass)
    icon:SetTexCoord(0.08, 0.92, 0.08, 0.92)

    local txt = btn:CreateFontString(nil, "ARTWORK")
    txt:SetFont("Fonts\\FRIZQT__.TTF", 8, "OUTLINE")
    txt:SetPoint("CENTER", icon)
    txt:SetText("A")
