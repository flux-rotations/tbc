...
if not NS then
    print("|cFFFF0000[Diddy AIO Hunter]|r Core module not loaded!")
    return
end
...
local function validate_playstyle_spells(playstyle)
    ...
    print("|cFF00FF00[Diddy AIO]|r Switched to Ranged playstyle")
...
-- MODULE LOADED
-- ============================================================================
print("|cFF00FF00[Diddy AIO Hunter]|r Class module loaded")