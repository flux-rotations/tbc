...
Action[A.PlayerClass] = {
	...
	DivineIllumination = Create({
		Type = "Spell",
		ID = 31842,
		Click = { unit = "player", type = "spell", spell = 31842 },
	}),

	-- Auras (persistent, self-cast)
	DevotionAura = Create({ Type = "Spell", ID = 465, useMaxRank = true, Click = { unit = "player", type = "spell" } }),
	RetributionAura = Create({
		Type = "Spell",
		ID = 7294,
		useMaxRank = true,
		Click = { unit = "player", type = "spell" },
	}),
	ConcentrationAura = Create({
		Type = "Spell",
		ID = 19746,
		Click = { unit = "player", type = "spell", spell = 19746 },
	}),
	SanctityAura = Create({ Type = "Spell", ID = 20218, Click = { unit = "player", type = "spell", spell = 20218 } }),
	ShadowResistAura = Create({
		Type = "Spell",
		ID = 19876,
		useMaxRank = true,
		Click = { unit = "player", type = "spell" },
	}),
	FrostResistAura = Create({
		Type = "Spell",
		ID = 19888,
		useMaxRank = true,
		Click = { unit = "player", type = "spell" },
	}),
	FireResistAura = Create({
		Type = "Spell",
		ID = 19891,
		useMaxRank = true,
		Click = { unit = "player", type = "spell" },
	...
	-- Blessings (self-cast)
	BlessingOfMight = Create({
		Type = "Spell",
		ID = 19740,
		useMaxRank = true,
		Click = { unit = "player", type = "spell" },
	}),
	BlessingOfWisdom = Create({
		Type = "Spell",
		ID = 19742,
		useMaxRank = true,
		Click = { unit = "player", type = "spell" },
...
rotation_registry:register_class({
	...
	extend_context = function(ctx)
		...
		ctx.has_any_seal = ctx.seal_blood_active
			or ctx.seal_command_active
			or ctx.seal_righteousness_active
			or ctx.seal_vengeance_active
			or ctx.seal_wisdom_active
			or ctx.seal_light_active
