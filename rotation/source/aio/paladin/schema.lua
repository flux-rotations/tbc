		...
		sections = {
			...
			},
			{
				...
				settings = {
					...
					{
						type = "checkbox",
						key = "ret_use_judgement",
						default = true,
						label = "Auto Judgement",
			...
			{
				header = "Execute & Fillers",
				settings = {
					{
						type = "checkbox",
						key = "ret_use_hammer_of_wrath",
						default = true,
			...
			},
			{
				...
				settings = {
					{
						type = "slider",
						key = "ret_aoe_threshold",
						default = 0,
						min = 0,
						max = 8,
						label = "AoE Threshold",
						tooltip = "Min enemies for Consecration auto-use. Set to 0 to disable auto-AoE.",
						format = "%d",
					},
				},
			},
		...
		sections = {
			{
				...
				settings = {
					...
					{
						type = "checkbox",
						key = "prot_prioritize_holy_shield",
						default = true,
			...
			{
				header = "Seal & Judgement",
				settings = {
					{
						type = "dropdown",
						key = "prot_seal_choice",
				...
				settings = {
					{
						...
						key = "prot_no_taunt",
						default = false,
						label = "Disable Taunts (Off-Tank)",
						tooltip = "Disables Righteous Defense. Use when off-tanking.",
					},
					{
						type = "checkbox",
						key = "prot_use_righteous_defense",
						default = true,
						label = "Auto Taunt",
		...
		sections = {
			{
				...
				settings = {
					{
						type = "slider",
						key = "holy_flash_of_light_hp",
						default = 90,
						min = 50,
						max = 100,
						label = "Flash of Light HP (%)",
						tooltip = "Use Flash of Light when target below this HP%. Most mana-efficient heal.",
						format = "%d%%",
					},
					{
						type = "slider",
						key = "holy_holy_light_hp",
						default = 60,
						min = 20,
						max = 80,
						label = "Holy Light HP (%)",
						tooltip = "Use Holy Light when target below this HP%. Big heal for heavy damage.",
						format = "%d%%",
					},
					{
						type = "checkbox",
						key = "holy_use_holy_shock",
						default = true,
						label = "Holy Shock",
					...
					{
						type = "slider",
						key = "holy_holy_shock_hp",
						default = 50,
						min = 20,
						max = 80,
						label = "Holy Shock HP (%)",
						tooltip = "Use Holy Shock instant heal when target below this HP%.",
						format = "%d%%",
					},
				},
			},
			{
				...
				settings = {
					...
					{
						type = "checkbox",
						key = "holy_use_divine_illumination",
						default = true,
					...
					{
						type = "slider",
						key = "holy_divine_illumination_pct",
						default = 60,
						min = 30,
						max = 80,
						label = "DI Mana Threshold (%)",
						tooltip = "Use Divine Illumination when mana drops below this percent.",
						format = "%d%%",
					},
				},
			},
			{
				...
				settings = {
					...
					{
						type = "checkbox",
						key = "holy_use_cleanse",
						default = true,
						label = "Auto Cleanse Party",
		...
		sections = {
			...
			S.trinkets("Use racial ability (Arcane Torrent, Stoneform, etc.) during combat."),
			{
				...
				settings = {
					{
						type = "checkbox",
						key = "use_seal_of_wisdom_low_mana",
						default = true,
						label = "Seal of Wisdom (Low Mana)",
						tooltip = "Automatically switch to Seal of Wisdom when mana drops below threshold.",
					},
					{
						type = "slider",
						key = "seal_of_wisdom_mana_pct",
						default = 20,
						min = 5,
						max = 50,
						label = "SoW Mana Threshold%",
						tooltip = "Switch to Seal of Wisdom when mana drops below this.",
						format = "%d%%",
					},
					{
						type = "checkbox",
					...
					},
					{
						...
						min = 10,
						max = 80,
						label = "Mana Potion Below%",
						tooltip = "Use Mana Potion when mana drops below this.",
						format = "%d%%",
					},
					{
						type = "checkbox",
					...
					},
					{
						...
						min = 10,
						max = 80,
						label = "Dark Rune Below%",
						tooltip = "Use Dark Rune when mana drops below this.",
						format = "%d%%",
					},
					{
						type = "slider",
						key = "dark_rune_min_hp",
						default = 50,
						min = 25,
						max = 75,
						label = "Dark Rune Min HP (%)",
						tooltip = "Only use Dark Rune when HP is above this (it costs HP).",
						format = "%d%%",
					},
				},
			},
